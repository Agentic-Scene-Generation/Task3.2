...
- GitHub：`Agentic-Scene-Generation/Task3.2` 的 `dev_yz_0910`，从 `dev_hrk_week37` 的 `6039165a65772b041d92b56a592559968818150b` 新建；只提交代码、测试、规范和小型核验证据，不上传模型、图片、向量库或凭据。
