...
DOWN_CATEGORIES = {
    "ceiling fan",
    "ceiling lamp",
    "ceiling lamp.n.01,track lighting",
    "chandelier",
    "pendant lamp",
    "range hood",
    "showerhead",
...
UP_CATEGORIES = {
    ...
    "roaster",
    "tissue box",
    "toilet brush.n.01,toilet brush holder",
    "candle",
    "candlestick",
    "candlestick.n.01,candle",
    "candle.n.01,candlestick",
    "candelabrum",
    "candle.n.01,candlestick.n.01,wall mirror",
    "firepit",
    "punching bag",
    "umbrella",
    "christmas tree",
...
HORIZONTAL_EXACT = {
    ...
    "makeup mirror",
    "mantel clock",
    "mantel clock.n.01,radio receiver",
    "media player",
    "medicine chest",
    "microphone",
    "microwave",
    ...
    "projector",
    "radio receiver",
    "radio receiver.n.01,alarm clock",
    "record player",
    "refrigerator",
    "safe",
    "sewing machine",
    "shoe rack",
    "shoe rack.n.01,cabinet",
    "shower faucet",
    "shower stall",
    "sink stand",
    "socket",
    ...
    "window",
    "chest of drawers",
    "chest of drawers.n.01,end table",
    "nightstand",
    "buffet",
    "picture frame",
    "tv stand",
    "bathtub",
    "bathtub.n.01,shower stall",
    "chaise longue",
    "l-shaped couch",
    "storage bench",
    "storage box",
    ...
    "towel rail",
    "towel ring",
    "towel rack.n.01,radiator",
    "coffee maker",
    "crib",
    "railing",
    "stairway.n.01,stairs",
    "fence",
    "gazebo",
    "playhouse",
    "playhouse.n.01,play area",
    "pet house",
    "cabin",
    "shed",
    "greenhouse",
    ...
    "hammock",
    "swing",
    "swing.n.02,play area",
    "slide",
    "playpen",
    "play area",
    "drying rack",
    "clothes dryer.n.01,drying rack",
    "rack",
    "magazine rack",
    "bicycle rack",
    "luggage rack",
    ...
    "toilet brush",
    "toilet paper holder",
    "paper towel.n.01,paper towel holder",
    "console table",
    "ottoman",
    "mattress",
    "cradle",
...
def write_lookup(path: Path, lookup: dict[str, dict[str, Any]]) -> None:
    ...
    with gzip.open(temp, "wt", encoding="utf-8") as handle:
        json.dump(
            lookup, handle, ensure_ascii=False, sort_keys=True, separators=(",", ":")
        )
    temp.replace(path)
...
def write_records(path: Path, lookup: dict[str, dict[str, Any]]) -> None:
    ...
    with temp.open("w", encoding="utf-8") as handle:
        for hssd_id in sorted(lookup):
            handle.write(
                json.dumps(lookup[hssd_id], ensure_ascii=False, sort_keys=True) + "\n"
            )
    temp.replace(path)
...
def patch_record(record: dict[str, Any], policy: dict[str, Any]) -> str:
    ...
    if preserved:
        ...
        horizontal_entries[0]["front_view_image_index"] = front.get(
            "front_view_image_index"
        )
        horizontal_entries[0]["render_evidence_view"] = front.get(
            "front_view_image_name"
        )
        horizontal_entries[0]["is_strict_positive_front"] = bool(
            front.get("is_strict_positive_front")
        )
        return "preserved"
...
def main() -> int:
    ...
    audit = {
        ...
        "strict_positive_front_count": sum(
            bool(r["is_strict_positive_front"]) for r in rows
        ),
        "horizontal_semantic_front_count": sum(bool(r["is_semantic"]) for r in rows),
        ...
        json.dumps(
            {
                ...
                for k in (
                    "asset_count",
                    "category_count",
                    "semantic_front_asset_count",
                    "strict_positive_front_count",
                    "functional_direction_counts",
                    "annotation_policy_counts",
                    "outcomes",
                )
            },
            indent=2,
