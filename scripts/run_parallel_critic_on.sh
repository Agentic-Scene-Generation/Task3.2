...
export SCENEEXPERT_CRITIC_INTEGRATION_ENABLED="${SCENEEXPERT_CRITIC_INTEGRATION_ENABLED:-true}"
export SCENEEXPERT_CRITIC_MEMORY_ENABLED="${SCENEEXPERT_CRITIC_MEMORY_ENABLED:-true}"
export SCENEEXPERT_CRITIC_REQUIRE_AVAILABLE="${SCENEEXPERT_CRITIC_REQUIRE_AVAILABLE:-true}"
export SCENEEXPERT_CRITIC_STAGE_GATE_ENABLED="${SCENEEXPERT_CRITIC_STAGE_GATE_ENABLED:-false}"
export SCENEEXPERT_CRITIC_PROVIDER_HARD_GATE="${SCENEEXPERT_CRITIC_PROVIDER_HARD_GATE:-false}"
export SCENEEXPERT_RUNTIME_BUDGET_ENABLED="${SCENEEXPERT_RUNTIME_BUDGET_ENABLED:-false}"
...
echo "SceneExpert critic bridge: enabled=$SCENEEXPERT_CRITIC_INTEGRATION_ENABLED memory=$SCENEEXPERT_CRITIC_MEMORY_ENABLED required=$SCENEEXPERT_CRITIC_REQUIRE_AVAILABLE"
echo "critic gates: sceneexpert=$SCENEEXPERT_CRITIC_STAGE_GATE_ENABLED provider=$SCENEEXPERT_CRITIC_PROVIDER_HARD_GATE"
echo "SceneExpert runtime budget injection: $SCENEEXPERT_RUNTIME_BUDGET_ENABLED"
if [ -n "$CONVEX_MAX_OMP_THREADS" ]; then
