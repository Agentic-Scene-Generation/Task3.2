...
def test_sync_transient_statuses_use_configured_retry_delays(monkeypatch):
    ...
    result = ReasoningPersistenceOpenAIClient(client=raw_client).responses.create(
